...
namespace TreniniDotNet.IntegrationTests.Catalog.V1.UseCases
{
    public class EditCatalogItemIntegrationTests : AbstractWebApplicationFixture
    {
        ...
        [Fact]
        public async Task EditCatalogItem_ShouldReturn401Unauthorized_WhenTheUserIsNotAuthenticated()
        {
        ...
        [Fact]
        public async Task EditCatalogItem_ShouldReturn404NotFound_WhenTheItemIsNotFound()
        {
        ...
        [Fact]
        public async Task EditCatalogItem_ShouldReturn409Conflict_WhenTheBrandIsNotFound()
        {
            var client = await CreateAuthorizedHttpClientAsync();
        ...
        [Fact]
        public async Task EditCatalogItem_ShouldReturn409Conflict_WhenTheScaleIsNotFound()
        {
            var client = await CreateAuthorizedHttpClientAsync();
        ...
        [Fact]
        public async Task EditCatalogItem_ShouldReturn200OK_WhenTheScaleIsUpdated()
        {
            var client = await CreateAuthorizedHttpClientAsync();
