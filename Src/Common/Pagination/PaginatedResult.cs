...
namespace TreniniDotNet.Domain.Pagination
{
    public sealed class PaginatedResult<TValue> : IEquatable<PaginatedResult<TValue>>
    {
        ...
        public static bool operator ==(PaginatedResult<TValue> left, PaginatedResult<TValue> right) => AreEquals(left, right);
        ...
        public bool Equals(PaginatedResult<TValue> other) => AreEquals(this, other);
